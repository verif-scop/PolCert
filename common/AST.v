...
Parameter ident_to_varname: ident -> string.
Parameter varname_to_ident : string -> ident.
Parameter bind_ident_varname : list (ident * string) -> list ident.
Parameter iterator_to_varname: nat -> string.