...
(** Below gives definition for contextual equivalence *)
(** - statement_ctxt is a 1-hole statement *)
(**** 1. the hole is not allowed nested inside switch, because its formalization is onerous, and have few use cases *)
Inductive statement_ctxt: Type := 
  | Chole: statement_ctxt
  | Cseq1: statement_ctxt -> statement -> statement_ctxt 
  | Cseq2: statement -> statement_ctxt -> statement_ctxt 
  | Cifthenelse1: expr -> statement_ctxt -> statement -> statement_ctxt
  | Cifthenelse2: expr -> statement -> statement_ctxt -> statement_ctxt
  | Cwhile: expr -> statement_ctxt -> statement_ctxt
  | Cdowhile: expr -> statement_ctxt -> statement_ctxt
  | Cfor: statement -> expr -> statement -> statement_ctxt -> statement_ctxt
  | Clabel: label -> statement_ctxt -> statement_ctxt
  . 

Fixpoint c_ctxt_stmt_compose 
   (cctxt: statement_ctxt) (cstmt: statement): statement := 
  match cctxt with 
  | Chole => cstmt
  | Cseq1 cctxt' cstmt' => Ssequence (c_ctxt_stmt_compose cctxt' cstmt) cstmt' 
  | Cseq2 cstmt' cctxt' => Ssequence cstmt' (c_ctxt_stmt_compose cctxt' cstmt)
  | Cifthenelse1 cexpr cctxt' cstmt' => Sifthenelse cexpr (c_ctxt_stmt_compose cctxt' cstmt) cstmt'
  | Cifthenelse2 cexpr cstmt' cctxt' => Sifthenelse cexpr cstmt' (c_ctxt_stmt_compose cctxt' cstmt)
  | Cwhile cexpr cctxt' => Swhile cexpr (c_ctxt_stmt_compose cctxt' cstmt)
  | Cdowhile cexpr cctxt' => Sdowhile cexpr (c_ctxt_stmt_compose cctxt' cstmt)
  | Cfor cstmt1 cexpr cstmt2 cctxt' => Sfor cstmt1 cexpr cstmt2 (c_ctxt_stmt_compose cctxt' cstmt)
  | Clabel clbl cctxt' => Slabel clbl (c_ctxt_stmt_compose cctxt' cstmt)
  end.
