...
Definition type_eqb (ty1 ty2: type) : bool := type_eq ty1 ty2.



Lemma type_eqb_eq : 
  forall ty1 ty2, 
    type_eqb ty1 ty2 = true <-> ty1 = ty2.
Proof.
  intros.
  split.
  - intro. 
    unfold type_eqb in H.
    unfold Coqlib.proj_sumbool in H.
    destruct (type_eq ty1 ty2) eqn:Heq; try discriminate; trivial.
  - intro.
    unfold type_eqb.
...
Lemma type_eqb_refl:
  forall ty, type_eqb ty ty = true.
Proof.
  intro; rewrite type_eqb_eq; trivial.
Qed.
